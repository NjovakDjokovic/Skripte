...
namespace Katarina
{
    ...
    {
        private const string MenuName = "Katarina";
        ...
        static Config()
        {
            ...
            Menu.AddGroupLabel("Welcome to my Simple Katarina addon!");
            Menu.AddLabel("Set Modes what ever you like :)!");
            Menu.AddLabel("Have fun! I hope you win! GL&HF!");
        ...
        public static class Modes
        {
            ...
            public static class LastHit
            {
                public static bool UseQ
                {
                    get { return Menu["lasthitUseQ"].Cast<CheckBox>().CurrentValue; }
                }

                static LastHit()
                {
                    Menu.AddGroupLabel("LastHit");
                    Menu.Add("lasthitUseQ", new CheckBox("Use Q"));
                }
